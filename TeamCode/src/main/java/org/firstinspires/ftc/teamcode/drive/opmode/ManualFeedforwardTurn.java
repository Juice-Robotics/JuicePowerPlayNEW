        ...
        while (!isStopRequested()) {
            ...
            switch (mode) {
                case TUNING_MODE:
                    ...
                    double targetPower = Kinematics.calculateMotorFeedforward(motionState.getV() * TRACK_WIDTH, motionState.getA() * TRACK_WIDTH, kV * scaleFactor, kA * scaleFactor, kStatic * scaleFactor);
